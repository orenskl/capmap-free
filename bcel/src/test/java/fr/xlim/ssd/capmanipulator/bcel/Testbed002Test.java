...
public class Testbed002Test {
    ...
    public void buildTestbed() {
        ProjectConfiguration configuration = new ProjectConfiguration(
                new File(FileManagement.getProjectRoot().getAbsolutePath() + File.separator + "various/testbeds/testbed002/"),
                new File(FileManagement.getModuleRoot().getAbsolutePath() + File.separator + "target/testbed002/")
        );
