...
import fr.xlim.ssd.capmanipulator.library.ConstantClassRef;
import fr.xlim.ssd.capmanipulator.library.exceptions.UnableToReadCapFileException;

public class ConstantClassRefRead implements ConstantPoolInfoRead {

    /**
     * read the values of the ConstantClassRef from a cap file and set this
     * values
     *
